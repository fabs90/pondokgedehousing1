    ...
    <div class="container detail-container">
        <div class="row">
            <div class="col-12 text-center mb-3">
                <img src="{{ asset('storage/images/' . $data->gambar) }}" class="detail-img img-fluid " alt="detail_image">
            </div>
            <div class="post-title mb-1" style="display: flex; flex-direction:column;">
                <p> <i class="bi bi-tag me-2"></i>{{ $data->category->name }}</p>
                <h2>{{ $data->judul }}</h2>
            ...
            <div class="col-lg-8 col-12" style="text-align: justify">
                {!! $data->isi !!}
            </div>
            <div class="col-lg-4 col-12 ">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="other-news d-flex flex-column">
                            <ol>
                                @foreach ($random as $item)
                                    <li>
                                        <h5>
                                            <a
                                                href="{{ route('showDetail', ['slug' => $item->slug]) }}">{{ $item->judul }}</a>
                                        </h5>
                                    </li>
                                @endforeach
                            </ol>
                        ...
                        <div class="widget">
                            ...
                            <form action="#!">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-12">
                                        <div class="input-group">
                                            <textarea class="form-control" id="textAreaExample" rows="3" placeholder="Ceritakan sedikit keluhan anda"
                                                required></textarea>
                                        </div>
                                    </div>
                                    <div class="col-4">
                ...
                <div class="row gy-4 gy-md-0">
                    <div class="col-xs-12 col-sm-6 col-md-4 order-0 order-md-0">
                        <div class="footer-logo-wrapper text-center text-sm-start">
                            <a href="#">
                                <img src="./assets/img/bsb-logo.svg" alt="KOMP.PGH 1" width="175" height="57">
                            </a>
                        </div>
                    </div>
