...
@section('pagename', 'Ubah Promo')
@section('page-title', 'Ubah Promo')
    ...
    <div class="container article-container">
        <div class="row">
            <div class="col-12 col-lg-10">
                <a href="{{ route('carousel.promo') }}" class="btn btn-success mb-2">Kembali</a>
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Ubah Promo</h5>

                        <!-- Vertical Form -->
                        <form class="row px-lg-4 px-3 g-3" method="POST"
                            action="{{ route('carousel.promo.update', ['slug' => $promo->slug]) }}"
                            ...
                            <div class="col-12 mb-lg-3 mb-2">
                                ...
                                <input type="text" class="form-control" id="inputKeterangan" name="input_keterangan"
                                    value="{{ $promo->keterangan }}" autocomplete="off" required>
                            </div>
